# -*- coding: utf-8 -*-
# Django settings for sysu_sscc project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sysu_sscc',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'v4$+$%fl6^p4)!!wht46&1t6-hhn)j3uez0!hu%xrf9^d7efmc'
...
WSGI_APPLICATION = 'sysu_sscc.wsgi.application'
